...
def calculate_der(original_content, target_content, arabic_letters, diacritic_classes, style, case_ending=True, no_diacritic=True):
...
def calculate_wer(original_content, target_content, arabic_letters, diacritic_classes, style, case_ending=True, no_diacritic=True):
  # with open(original_file, 'r') as file:
  #   original_content = file.readlines()
  #
  # with open(target_file, 'r') as file:
...
if __name__ == '__main__':
  ...
  parser.add_argument('-ofp', '--original-file-path', help='File path to original text', default='/Users/zjy/Downloads/arabic-text-diacritization-master/helpers/pred')
  parser.add_argument('-tfp', '--target-file-path', help='File path to target text', default='/Users/zjy/Downloads/arabic-text-diacritization-master/helpers/gold')
